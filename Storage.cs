...
namespace module_12_exercise_1
{
    internal class Storage
    {
        ...
        public void AccountAdd(int id, int clientID, object accountNumber, object accountSumm) //метод добавления нового клиента в базу
        {
